...
function AdminUsers() {
  ...
  return <div className="admin-users-page">
    ...
    <div className="admin-users-layout">
      <section className="admin-panel create-user-panel"><div className="panel-heading"><div><p className="eyebrow">NEW ACCOUNT</p><h2>Add dashboard user</h2></div><span className="admin-only-label">ADMIN ONLY</span></div><form className="create-user-form" onSubmit={handleCreate}>
